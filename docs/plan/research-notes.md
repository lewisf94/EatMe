...
- **Controller alternatives:** XIAO ESP32-C6 is the best compact documented option. DFRobot FireBeetle 2 ESP32-C6 v1.2 is larger and sleeps at a specified 36 uA, but integrates LiPo management and a documented 5 V solar input. Waveshare ESP32-C6-Zero lacks a charger and a published board-level sleep figure.
